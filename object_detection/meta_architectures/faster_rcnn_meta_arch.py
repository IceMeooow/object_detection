...
class FasterRCNNMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    Args:
      ...
      num_classes: Number of classes.  Note that num_classes *does not*
        include the background category, so if groundtruth data take values
  ...
  def _loss_box_classifier(self,
    ...
    Please note that for boxes and masks with multiple data, the box
    ...
    with tf.name_scope('BoxClassifierLoss'):
      ...
      # For anchors with multiple data, picks refined_location_encodings
