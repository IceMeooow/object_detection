...
def _get_labels_dict(input_dict):
  """Extracts data dict from input dict."""
  required_label_keys = [
      fields.InputDataFields.num_groundtruth_boxes,
...
def create_train_input_fn(train_config, train_input_config,
  ...
  def _train_input_fn(params=None):
    """Returns `features` and `data` tensor dictionaries for training.

    Args:
      params: Parameter dictionary passed from the estimator.

    Returns:
      A tf.data.Dataset that holds (features, data) tuple.
      ...
      data: Dictionary of groundtruth tensors.
        data[fields.InputDataFields.num_groundtruth_boxes] is a [batch_size]
          int32 tensor indicating the number of groundtruth boxes.
        data[fields.InputDataFields.groundtruth_boxes] is a
          [batch_size, num_boxes, 4] float32 tensor containing the corners of
          the groundtruth boxes.
        data[fields.InputDataFields.groundtruth_classes] is a
          [batch_size, num_boxes, num_classes] float32 one-hot tensor of
          classes.
        data[fields.InputDataFields.groundtruth_weights] is a
          [batch_size, num_boxes] float32 tensor containing groundtruth weights
          for the boxes.
        -- Optional --
        data[fields.InputDataFields.groundtruth_instance_masks] is a
          [batch_size, num_boxes, H, W] float32 tensor containing only binary
          values, which represent instance masks for objects.
        data[fields.InputDataFields.groundtruth_keypoints] is a
...
def create_eval_input_fn(eval_config, eval_input_config, model_config):
  ...
  def _eval_input_fn(params=None):
    """Returns `features` and `data` tensor dictionaries for evaluation.
    ...
    Returns:
      ...
      data: Dictionary of groundtruth tensors.
        data[fields.InputDataFields.groundtruth_boxes] is a [1, num_boxes, 4]
          float32 tensor containing the corners of the groundtruth boxes.
        data[fields.InputDataFields.groundtruth_classes] is a
          [num_boxes, num_classes] float32 one-hot tensor of classes.
        data[fields.InputDataFields.groundtruth_area] is a [1, num_boxes]
          float32 tensor containing object areas.
        data[fields.InputDataFields.groundtruth_is_crowd] is a [1, num_boxes]
          bool tensor indicating if the boxes enclose a crowd.
        data[fields.InputDataFields.groundtruth_difficult] is a [1, num_boxes]
