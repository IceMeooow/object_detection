...
class BootstrappedSigmoidClassificationLoss(Loss):
  ...
  This loss uses a convex combination of training data and the current model's
  ...
  can use these predictions to mitigate the damage of noisy/incorrect data,
  because incorrect data are likely to be eventually highly inconsistent with
