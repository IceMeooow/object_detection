...
4) Assigning classification targets based on the matching and groundtruth data
...
class TargetAssigner(object):
  ...
  # TODO(rathodv): move data, scores, and weights to groundtruth_boxes fields.
  def assign(self,
             anchors,
             groundtruth_boxes,
    ...
    Args:
      ...
      groundtruth_labels:  a tensor of shape [M, d_1, ... d_k]
        with data for each of the ground_truth boxes. The subshape
      ...
      unmatched_class_label: a float32 tensor with shape [d_1, d_2, ..., d_k]
        ...
        compatible with the groundtruth data that are passed to the "assign"
  ...
  def _create_classification_targets(self, groundtruth_labels,
    ...
    Args:
      groundtruth_labels:  a tensor of shape [num_gt_boxes, d_1, ... d_k]
        with data for each of the ground_truth boxes. The subshape
        [d_1, ... d_k] can be empty (corresponding to scalar data).
      unmatched_class_label: a float32 tensor with shape [d_1, d_2, ..., d_k]
        which is consistent with the classification target for each
        anchor (and can be empty for scalar targets).  This shape must thus be
        compatible with the groundtruth data that are passed to the "assign"
