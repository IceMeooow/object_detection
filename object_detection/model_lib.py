...
def create_train_and_eval_specs(train_input_fn,
  ...
  Args:
    train_input_fn: Function that produces features and data on train data.
    eval_input_fn: Function that produces features and data on eval data.
    eval_on_train_input_fn: Function that produces features and data for
