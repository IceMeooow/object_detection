...
# ==============================================================================
r"""An executable to expand hierarchically image-level data and boxes.
...
--annotation_type=<1 (for boxes) or 2 (for image-level data)>
"""
...
def _build_plain_hierarchy(hierarchy, skip_root=False):
  ...
  Args:
   hierarchy: data hierarchy as JSON file.
...
class OIDHierarchicalLabelsExpansion(object):
  """ Main class to perform data hierachical expansion."""

  def __init__(self, hierarchy):
    """Constructor.

    Args:
      hierarchy: data hierarchy as JSON object.
    """
